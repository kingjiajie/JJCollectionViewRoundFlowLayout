...
//
//  Created by jiajie on 2021/9/12.
...
@interface SeventhViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,JJCollectionViewDelegateRoundFlowLayout>
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGSize size = [SeventhViewController calculateStringViewSizeWithShowSize:CGSizeMake(CGFLOAT_MAX, 38.f) fontSize:[UIFont systemFontOfSize:15.f] string:string];
